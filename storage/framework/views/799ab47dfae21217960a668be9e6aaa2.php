...
<body class="bg-light">
  ...
  <div class="container py-4">
    ...
    <div class="card shadow-sm mb-4 border-warning">
      ...
      <div class="card-body">
        <form action="<?php echo e(route('users.update', $editUser->id)); ?>" method="POST">
          <?php echo csrf_field(); ?>
          <div class="row g-3">
            <div class="col-md-4">
              <label class="form-label">Full Name</label>
              <input type="text" name="fullname" class="form-control"
                     value="<?php echo e($editUser->name); ?>" required>
            </div>
            <div class="col-md-4">
              <label class="form-label">Gender</label>
              <select name="gender" class="form-select" required>
                <option value="" disabled>Select gender</option>
                <option value="Male"           <?php echo e($editUser->gender == 'Male'           ? 'selected' : ''); ?>>Male</option>
                <option value="Female"         <?php echo e($editUser->gender == 'Female'         ? 'selected' : ''); ?>>Female</option>
                <option value="Rather not say" <?php echo e($editUser->gender == 'Rather not say' ? 'selected' : ''); ?>>Rather not say</option>
              </select>
            </div>
            <div class="col-md-4">
              <label class="form-label">Email</label>
              <input type="email" name="email" class="form-control"
                     value="<?php echo e($editUser->email); ?>" required>
            </div>
            <div class="col-md-4">
...
</html><?php /**PATH C:\xampp\htdocs\Laravel-Jabolin\resources\views/users.blade.php ENDPATH**/ ?>