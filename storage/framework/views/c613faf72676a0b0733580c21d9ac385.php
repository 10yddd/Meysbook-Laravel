...
<body class="bg-light">
  ...
  <div class="container py-5">
    ...
    <h1 class="fw-bold mb-4">Welcome only, <?php echo e(session('user')->name); ?></h1>
      ...
      <div class="col-md-4">
        <div class="card text-white bg-primary shadow-sm">
          <div class="card-body">
            ...
            <h2 class="fw-bold"><?php echo e($totalUsers); ?></h2>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card text-white bg-success shadow-sm">
          <div class="card-body">
            ...
            <h2 class="fw-bold"><?php echo e($totalReservations); ?></h2>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card text-white bg-info shadow-sm">
          <div class="card-body">
            ...
            <h5 class="fw-bold"><?php echo e(session('user')->gender ?? 'N/A'); ?></h5>
          </div>
        </div>
      </div>
    </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            label: 'Total Count',
            data: [<?php echo e($totalUsers); ?>, <?php echo e($totalReservations); ?>],
            backgroundColor: [
              'rgba(13, 110, 253, 0.7)',
              'rgba(25, 135, 84, 0.7)'
            ],
...
</html><?php /**PATH C:\xampp\htdocs\Laravel-Jabolin\resources\views/dashboard.blade.php ENDPATH**/ ?>